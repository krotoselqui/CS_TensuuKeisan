    ...
    class Program
    {
        ...
        static string makeYaku(int yakuNum, out int[] out_tehai, out int[][] out_furotehai, out int[] out_furotype, out int out_machi_xs)
        {
            ...
            else if (yakuNum == 14 || yakuNum == 18 || yakuNum == 19 || yakuNum == 20) //役牌
            {
                ...
                if (type == 0)
                {
                    MeldGenerator.MakeRandomKantsu(14, ref maisu, out strparts, out xsparts, 3, yakuxs_num);
                    partsType[0] = 3 + furo;
                }
                else
                {
                ...
                for (int i = 1; i < 4; i++)
                {
                    ...
                    {
                        MeldGenerator.MakeRandomKantsu(14, ref maisu, out strparts, out xsparts);
                        partsXS[i] = xsparts;
                        partsType[i] = 3 + furo;
            ...
            else if (yakuNum == 39) //大三元
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    {
                        MeldGenerator.MakeRandomKantsu(yakuNum, ref maisu, out strparts, out xsparts, 3, i + 5);
                        partsXS[i] = xsparts;
                        partsType[i] = 3 + retOne(furo_bairitsu);
                    }
