...
namespace MahjongScoreTrainer
{
    ...
    class Program
    {
        ...
        static string makeYaku(int yakuNum, out int[] out_tehai, out int[][] out_furotehai, out int[] out_furotype, out int out_machi_xs)
        {
            ...
            {
                YakuMeldGenerator.GenerateShousangen(ref maisu, partsXS, partsType, ref machi_xs);
            }
                        else if (yakuNum == YakuNumbers.Honroutou) //混老頭
            {
                YakuMeldGenerator.GenerateHonroutou(ref maisu, partsXS, partsType, ref machi_xs);
            }
            ...
            {
                YakuMeldGenerator.GenerateJunchantaiyaochuu(ref maisu, partsXS, partsType, ref machi_xs);
            }
